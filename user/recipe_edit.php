...
$recipe_res = mysqli_query($conn, "SELECT * FROM recipe WHERE recipe_id = '$recipe_id' AND user_id = '$user_id'");
...
// Fetch Existing Ingredients via 'uses' table
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Image Upload (Keep old if new one isn't uploaded)
    ...
    if (mysqli_query($conn, $update_query)) {
        ...
        // Update Category Link: Delete old association and insert new one
        ...
        // Update Ingredients: Delete old links and insert new ones
        ...
        header("Location: my_recipes.php?msg=updated");
        exit();
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Edit Recipe | CookEasy</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel ="stylesheet" href="../assets/css/user/recipe_edit.css">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div id="ingredient-list">
                        <?php 
                        mysqli_data_seek($ing_res, 0); // Reset result pointer
